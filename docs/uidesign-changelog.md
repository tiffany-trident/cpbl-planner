...
### 2026-04-22 `97f5dae`..`50e656f` — Phase 1 個人化功能（5 commits）

Phase 1 engagement roadmap 實作到分支 `feat/phase1-personalization`。5 個 commit 依序：Schema v1 → 篩選記憶 → 場次收藏 → 主隊設定 → 觀戰打卡。尚未 merge 回 main。
